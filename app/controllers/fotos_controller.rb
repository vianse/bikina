class FotosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @foto.save
        format.html { redirect_to :back, notice: 'Foto was successfully created.' }
  ...
  def destroy
    @foto.destroy
    respond_to do |format|
      format.html { redirect_to :back, notice: 'Foto was successfully destroyed.' }
  ...
  private
    ...
    def foto_params
      params.require(:foto).permit(:photo, :registro_id,:user_id, :grupo_id)
    end
end
